...
const FeaturesCard = ({ imagePath, cardText, delay = 0 }) => {
  return (
    <motion.div
      ...
      className="flex flex-col items-center border-2 border-[#DEDEDE1A]/10 rounded-lg space-y-4 sm:space-y-6 relative py-4 sm:py-5 px-3 sm:px-4 overflow-hidden min-h-[180px] sm:min-h-[200px]"
